...
public class SecretCalculator {
	...
	public enum OperationType {
		ADD((number1, number2) -> number1.add(number2)), SUB((number1, number2) -> number1.subtract(number2)), MUL(
				(number1, number2) -> number1.multiply(number2)), DIV(
						(number1, number2) -> number1.divide(number2)), MOD((number1, number2) -> number1.mod(number2));
